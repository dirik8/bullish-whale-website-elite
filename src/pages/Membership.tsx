        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-300">
              Joining BWC is by invitation only. We seek committed, growth-focused individuals who value accountability and performance.
              Our vetting process ensures alignment between members and our elite values.
            </p>
          </div>
            ...
            <div className="space-y-10">
              <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 animate-scale-in">
                ...
                <div className="space-y-6">
                  <ProcessStep 
                    ...
                    description="Fill out our comprehensive application form to help us understand your trading background and goals."
                  />
                  <ProcessStep 
                    number="02" 
                    title="1:1 Interview" 
                    description="Selected applicants will be invited for a personal interview with our membership team."
                  />
                  <ProcessStep 
                    number="03" 
                    title="Invitation Decision" 
                    description="Based on alignment with our community values and goals, select applicants will receive an invitation."
                  />
                </div>
              </div>
              ...
              <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 animate-scale-in" style={{ animationDelay: "0.2s" }}>
                ...
                <p className="text-gray-300">
                  To maintain our high service standards and exclusive community environment, 
                  <span className="text-white font-semibold"> only 50 spots per quarter are made available</span>. 
                  This ensures personalized attention and maintains the elite nature of our community.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 animate-scale-in" style={{ animationDelay: "0.3s" }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  />
                  <FormField
                    label="Estimated Liquid Investment Capital (USD)"
                    name="capital"
                    type="text"
                ...
                <div className="space-y-6">
                  ...
                  <FormField
                    label="Other Active Investments or Assets"
                    name="investments"
                    type="text"
                  ...
                  <FormField
                    label="Current Brokerage Accounts or Platforms"
                    name="platforms"
                    type="text"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full bg-gray-800 border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-brand-gold min-h-[100px]"
                      required
                    ></textarea>
                  </div>
      ...
      <section className="bg-gray-900 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            Join an elite community of traders who are committed to excellence and consistently outperforming the market.
          </p>
          <GoldButton size="lg">Apply for Membership</GoldButton>
        </div>
      </section>
    </Layout>
  );
